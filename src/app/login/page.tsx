    ...
    <div className="flex h-[80vh] items-center justify-center">
      <div className="w-2/5 rounded-3xl p-8 border-2 border-gray-500">
        <div className="flex items-center flex-col ">
          <h1 className="text-2xl mt-4 font-semibold">Login</h1>
          <h1 className="text-xl font-medium mt-4">Welcome back to ECOMMERCE</h1>
          <h1 className="mt-4 mb-8">The next gen business marketplace</h1>
        ...
        <div>Dont have an account?<Link className="ml-4" href="/">SIGN UP</Link></div>
        </div>
      </div>
    </div>
  );
